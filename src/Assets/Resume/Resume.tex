...
\resumeProjectHeading
    ...
    \resumeItemListStart
        ...
        \resumeItem{Gained extensive experience in AWS, containerization, cloud architecture, and Power BI.}
    \resumeItemListEnd
...
\section{\textcolor{\accentColor}{Technical Skills}}
 \begin{itemize}[leftmargin=0.15in, label={}]
    ...
    \textbf{Certifications: }{AWS Cloud Practitioner, AWS AI Practitioner, AWS Solutions Architect Associate} \\
     ...
     \textbf{Developer Tools: }{VS Code, Power BI, MongoDB, Postgres, Postman, Figma} \\
