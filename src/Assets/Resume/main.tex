...
\resumeProjectHeading
    ...
    \resumeItemListStart
        \resumeItem{Designed, developed, and deployed containerized cloud-based web scraper to save \$100k+ in operating expenses.}
        \resumeItem{Operationalizing study-specific AI agent/knowledge bases using existing data repository to support study teams.}
        \resumeItem{Optimizing data pipeline processing and analytical database queries, improving insight delivery timelines.}
        \resumeItem{Gained extensive experience in AWS, containerization, serverless functions, and PowerBI.}
    \resumeItemListEnd
...
\resumeProjectHeading
    ...
    \resumeItemListStart
        \resumeItem{The industry uses tools that are never taught in classes. So I am leading technical workshops on modern software topics including containerization, cloud fundamentals, web development, and git fundamentals.}
        \resumeItem{Leading the design, development, and deployment of new full-stack websites for UCSD clubs.}
    \resumeItemListEnd
...
\resumeProjectHeading
    ...
    \resumeItemListStart
        ...
        \resumeItem{Collaborated with policy researchers to define sentiment analysis objectives, aligning technical deliverables with real-world policy impact and public communication goals.}
    \resumeItemListEnd
