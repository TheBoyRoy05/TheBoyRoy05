        ...
        <div className="flex-col w-[80vw] md:w-[60vw]">
            ...
            <div className="flex-col gap-4">
              ...
              <div className="flex flex-col lg:flex-row ~gap-4/12 ~text-base/lg ~leading-7/8">
                <p className="flex-1">
                  ...
                  Algebra, and tears? <span className="text-white">A:</span> A slightly awful
                  graphics engine that runs on the CPU! <span className="text-white">Why?</span>{" "}
                  Because I like making things from scratch.
                </p>
                <p className="flex-1">
            ...
            <div className="flex flex-col lg:flex-row-reverse gap-6">
              <div className="flex-1 flex-col justify-center gap-6 ~text-base/lg ~leading-7/8">
                <p>
                  ...
                  to guide the development process. Modern graphics APIs like OpenGL and DirectX
                  make it easy to create beautiful visuals, but they also hide a lot of the details.
                </p>
                <p>
          ...
          <div id="pipeline" className="flex-col gap-10 ~pt-6/14">
            ...
            <div className="flex flex-col lg:flex-row ~gap-4/12 ~text-base/lg ~leading-7/8">
              ...
              <p className="flex-1">
                Understanding this pipeline is crucial for graphics programming. From loading
                vertices from OBJ files to calculating lighting and sampling textures, every stage
                requires <Emphasize text="careful attention" /> to detail and a solid grasp of
                linear algebra.
              </p>
            </div>
          ...
          <div id="lighting" className="flex-col gap-10 ~pt-6/14">
            ...
            <div className="flex flex-col lg:flex-row gap-6 ~pb-8/20">
              <div className="flex-1 flex-col justify-center gap-6 ~text-base/lg ~leading-7/8">
                <p>
                  <span className="text-white">
                    Lighting and texturing bring 3D scenes to life.
                  </span>{" "}
                  I implemented both directional and point lights, calculating diffuse shading based
                  on surface normals. The lighting model uses{" "}
                  <Emphasize text="Lambertian shading" />, which creates realistic depth and
                  dimension.
                </p>
                <p>
                  Texture mapping was one of the more challenging features to implement. It requires
                  careful interpolation of UV coordinates across triangle surfaces and proper
                  texture sampling. The result is <Emphasize text="detailed" /> and{" "}
            ...
            <div className="flex flex-col lg:flex-row gap-6">
              ...
              <div className="flex-1 flex-col gap-6 ~text-base/lg ~leading-7/8">
                <p>
                  ...
                  One of the hardest parts was debugging matrix transformations. When a model
                  appears upside-down or in the wrong position, it's not immediately obvious where
                  the bug is. I spent many hours{" "}
                  <Emphasize text="tracing through matrix multiplications" /> and checking
                ...
                <p>
                  ...
                  textures to display correctly without distortion or artifacts was a process of
                  trial and error and I ended up spending many hours on it, but the end result was
                  worth it.
                </p>
                <p>
                  I tried implementing <Emphasize text="multithreading" /> on the CPU to somewhat
                  simulate GPU performance by parallelizing the rendering work across multiple
                  cores. However, it only <Emphasize text="marginally improved" /> rendering speed.
                  In the future, I would like to add GPU rendering using OpenGL or Vulkan to improve
                  performance.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row gap-6">
              <div className="flex-1 flex-col justify-center gap-6 ~text-base/lg ~leading-7/8">
                <p>
                  ...
                  The most obvious next step would be moving to GPU rendering using OpenGL or
                  Vulkan, which would unlock <Emphasize text="realistic performance" /> and enable
                  more complex scenes.
                </p>
                <p>
                  I'd also love to add more advanced lighting features like{" "}
                  <Emphasize text="shadows" />, <Emphasize text="reflections" />, and
                  physically-based rendering. A scene graph system would make it easier to organize
                  and render complex scenes, and physics integration would add interactivity.
                </p>
              </div>
